<%@ page language="VB" autoeventwireup="false" inherits="DisplayCrewInfo112_4C, App_Web_orc10za4" %>
...
<body>
    ...
    <asp:Button ID="Button1" runat="server" Text="Bldg 112 CREWS" />  
...
<AlternatingRowStyle BackColor="White" ForeColor="#000000"></AlternatingRowStyle>
    <Columns>
        ...
        <asp:BoundField DataField="Crew" HeaderText="Crew" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center" />
