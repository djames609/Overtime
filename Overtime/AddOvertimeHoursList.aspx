<%@ page language="VB" autoeventwireup="false" inherits="AddOvertimeHoursList, App_Web_orc10za4" %>
...
<body style = "font-family:Arial;font-size:10pt">
    <form id="form1" runat="server" defaultbutton="BtnInsert">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="EmployeeID" ItemStyle-Width = "150">
             ...
             <asp:TemplateField HeaderText="DateAsked" ItemStyle-Width = "400">
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="TxtDateEntered" runat="server" class="actualin"  Text='<%# Eval("DateEntered") %>' Visible="false"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ControlToValidate="TxtDateEntered" ErrorMessage="Enter Valid Date" ForeColor="Red"></asp:RequiredFieldValidator>
                </ItemTemplate>
            </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="AskType" ItemStyle-Width = "50">
            ...
            <asp:TemplateField HeaderText="WorkedHours" ItemStyle-Width = "50">
             ...
             <asp:TemplateField HeaderText="PlantDate" ItemStyle-Width = "400">
                <ItemTemplate>
           ...
           <asp:TemplateField HeaderText="DateChanged" ItemStyle-Width = "400">
                <ItemTemplate>
                    <asp:Label ID="Label16" runat="server" Text='<%# Eval("DateChanged") %>'></asp:Label>
    ...
    <asp:Button ID="BtnInsert" runat="server" Text="Insert/Save" OnClick = "Insert" Visible = "True"/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
