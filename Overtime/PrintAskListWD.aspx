<%@ page language="VB" autoeventwireup="false" inherits="PrintAskListWD, App_Web_orc10za4" %>
         ...
         <Columns>
          ...
          <asp:TemplateField HeaderText="Name" ItemStyle-Width = "150"  >
            ...
            <asp:TemplateField HeaderText="Refuse Count WE" ItemStyle-Width = "30">
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Font-Size="10pt" Text='<%# Eval("TotalMandatoryRefuseCountWE") %>'></asp:Label>
                    <asp:TextBox ID="TxtRefCountWE" runat="server" ReadOnly = "True" Text='<%# Eval("TotalMandatoryRefuseCountWE") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
           <asp:BoundField DataField="Day1" ItemStyle-Width = "30"/>
