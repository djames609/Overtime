<%@ page language="VB" autoeventwireup="false" inherits="cutoffdisplay, App_Web_orc10za4" %>
        ...
        <alternatingrowstyle backcolor="PaleTurquoise"  
         ...
         <Columns>
          ...
          <asp:TemplateField HeaderText="Name" ItemStyle-Width = "150"  >
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Font-Size="12pt" Text='<%# Eval("Name") %>'></asp:Label>
            ...
            <asp:TemplateField HeaderText="Crew" ItemStyle-Width = "100" >
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Font-Size="12pt" Text='<%# Eval("Crew") %>'></asp:Label>
            ...
            <asp:TemplateField HeaderText="PlantDate"  ItemStyle-Width = "50">
                <ItemTemplate>
                    <asp:Label ID="Label3" runat="server" Font-Size="12pt" Text='<%# Eval("PlantDate") %>'></asp:Label>
            ...
            <asp:TemplateField HeaderText="Charged Hours" ItemStyle-Width = "30">
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Font-Size="12pt" Text='<%# Eval("ChargedHours") %>'></asp:Label>
...
&nbsp;<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        ...
        <alternatingrowstyle backcolor="PaleTurquoise"  
         ...
         <Columns>
          ...
          <asp:TemplateField HeaderText="Name" ItemStyle-Width = "150"  >
                <ItemTemplate>
                    <asp:Label ID="Label101" runat="server" Font-Size="12pt" Text='<%# Eval("Name") %>'></asp:Label>
                    <asp:TextBox ID="TxtName" runat="server" ReadOnly = "True" Text='<%# Eval("Name") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Crew" ItemStyle-Width = "100" >
                <ItemTemplate>
                    <asp:Label ID="Label102" runat="server" Font-Size="12pt" Text='<%# Eval("Crew") %>'></asp:Label>
                    <asp:TextBox ID="Txtcrew" runat="server" ReadOnly = "True" Text='<%# Eval("Crew") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="PlantDate"  ItemStyle-Width = "50">
                <ItemTemplate>
                    <asp:Label ID="Label103" runat="server" Font-Size="12pt" Text='<%# Eval("PlantDate") %>'></asp:Label>
                    <asp:TextBox ID="TxtPltDate" runat="server" ReadOnly = "True" Text='<%# Eval("PlantDate") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Charged Hours" ItemStyle-Width = "30">
                <ItemTemplate>
                    <asp:Label ID="Label114" runat="server" Font-Size="12pt" Text='<%# Eval("ChargedHours") %>'></asp:Label>
                    <asp:TextBox ID="TxtChgHrs" runat="server" ReadOnly = "True" Text='<%# Eval("ChargedHours") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
             <asp:BoundField DataField="Day1" ItemStyle-Width = "70" HeaderText="Day1 Early/Over"/>
