<%@ page language="VB" autoeventwireup="false" inherits="DisplayCrewInfo6, App_Web_orc10za4" %>
...
<AlternatingRowStyle BackColor="White" ForeColor="#000000"></AlternatingRowStyle>
    <Columns>
        ...
        <asp:BoundField DataField="PlantDate" HeaderText="PlantDate" ItemStyle-Width="140" ItemStyle-HorizontalAlign="Center"/>
...
<asp:GridView ID="GridView2" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Crew" HeaderText="Crew" ItemStyle-Width="50" ItemStyle-HorizontalAlign="Center" />
        <asp:BoundField DataField="PlantDate" HeaderText="PlantDate" ItemStyle-Width="140"  ItemStyle-HorizontalAlign="Center"/>
        <asp:BoundField DataField="Phone" HeaderText="Phone" ItemStyle-Width="140" />
...
<asp:GridView ID="GridView4" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
    RowStyle-BackColor="#A1DCF2" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000"
    runat="server" DataKeyNames="ID" AutoGenerateColumns="false" ShowFooter="true" 
        Font-Size="Small">
    <Columns>
