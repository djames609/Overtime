<%@ page language="VB" autoeventwireup="false" inherits="UpdateOvertimeHoursList, App_Web_orc10za4" %>
...
<body style = "font-family:Arial;font-size:10pt">
    ...
    <asp:GridView ID="gvOT" runat="server" AutoGenerateColumns="false" OnRowDataBound = "OnRowDataBound" DataKeyNames = "ID" EmptyDataText="No records have been added.">
    <rowstyle backcolor="LightCyan"  
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="EmployeeID" ItemStyle-Width = "150">
             ...
             <asp:TemplateField HeaderText="OvertimeType" ItemStyle-Width = "150">
                <ItemTemplate>
                    <asp:Label ID="Label25" runat="server" Text='<%# Eval("OvertimeType") %>'></asp:Label>
                    <asp:TextBox ID="TxtOT" runat="server" ReadOnly = "True" Text='<%# Eval("OvertimeType") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
             <asp:TemplateField HeaderText="AskType" ItemStyle-Width = "150">
                <ItemTemplate>
                    <asp:Label ID="Label26" runat="server" Text='<%# Eval("AskType") %>'></asp:Label>
                    <asp:TextBox ID="TxtAsk" runat="server" ReadOnly = "True" Text='<%# Eval("AskType") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="DateChanged" ItemStyle-Width = "100">
                <ItemTemplate>
                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("DateChanged") %>'></asp:Label>
                    <asp:TextBox ID="TxtChangeDate" runat="server" ReadOnly = "True"  Text='<%# Eval("DateChanged") %>' Visible="false"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
